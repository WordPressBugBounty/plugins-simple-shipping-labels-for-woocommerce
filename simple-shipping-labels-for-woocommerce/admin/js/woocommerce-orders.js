...
function generateLabels() {
	...
	// Get legacy orders page selected orders and HPOS
	var checkedOrders = document.querySelectorAll('input[name="post[]"]:checked, input[name="id[]"]:checked');

	// Declare list of orders ids to generate labels for.
	var orders = [];
