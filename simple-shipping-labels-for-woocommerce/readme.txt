...
= 1.0.7 – 2024-02-05 =
* Fix: Refactored code base to support WooCommerce **[HPOS](https://woo.com/document/high-performance-order-storage/)** ("High Performance Order Storage"), based on the official **[Upgrade Recipe Book](https://github.com/woocommerce/woocommerce/wiki/High-Performance-Order-Storage-Upgrade-Recipe-Book)**.
